        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            <div className="grid grid-cols-2 gap-4">
              {/* Large card */}
              <div className="col-span-2 aspect-[16/9] rounded-3xl overflow-hidden bg-nude-200 shadow-xl">
                <div className="w-full h-full bg-gradient-champagne flex items-center justify-center">
                  <span className="text-6xl">💅</span>
                </div>
              </div>
              {/* Small cards */}
              <div className="aspect-square rounded-2xl overflow-hidden bg-nude-100 shadow-lg">
                <div className="w-full h-full bg-gradient-nude flex items-center justify-center">
                  <span className="text-4xl">✨</span>
                </div>
              </div>
              <div className="aspect-square rounded-2xl overflow-hidden bg-champagne-100 shadow-lg">
                <div className="w-full h-full bg-gradient-champagne flex items-center justify-center">
                  <span className="text-4xl">🌸</span>
                </div>
              </div>
